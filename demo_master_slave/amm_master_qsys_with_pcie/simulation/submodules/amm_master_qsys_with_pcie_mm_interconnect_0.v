...
module amm_master_qsys_with_pcie_mm_interconnect_0 (
	...
	wire    [4:0] rsp_mux_src_channel;                                                            // rsp_mux:src_channel -> custom_module_avalon_master_agent:rp_channel
	...
	wire  [149:0] rsp_mux_002_src_data;                                                           // rsp_mux_002:src_data -> sgdma_m_write_agent:rp_data
	wire          rsp_mux_002_src_ready;                                                          // sgdma_m_write_agent:rp_ready -> rsp_mux_002:src_ready
	wire    [4:0] rsp_mux_002_src_channel;                                                        // rsp_mux_002:src_channel -> sgdma_m_write_agent:rp_channel
	...
	wire  [113:0] rsp_mux_003_src_data;                                                           // rsp_mux_003:src_data -> sgdma_descriptor_read_agent:rp_data
	wire          rsp_mux_003_src_ready;                                                          // sgdma_descriptor_read_agent:rp_ready -> rsp_mux_003:src_ready
	wire    [4:0] rsp_mux_003_src_channel;                                                        // rsp_mux_003:src_channel -> sgdma_descriptor_read_agent:rp_channel
	...
	wire  [113:0] rsp_mux_004_src_data;                                                           // rsp_mux_004:src_data -> sgdma_descriptor_write_agent:rp_data
	wire          rsp_mux_004_src_ready;                                                          // sgdma_descriptor_write_agent:rp_ready -> rsp_mux_004:src_ready
	wire    [4:0] rsp_mux_004_src_channel;                                                        // rsp_mux_004:src_channel -> sgdma_descriptor_write_agent:rp_channel
	...
	wire  [149:0] sgdma_m_read_agent_cp_data;                                                     // sgdma_m_read_agent:cp_data -> router_001:sink_data
	...
	wire  [149:0] sgdma_m_write_agent_cp_data;                                                    // sgdma_m_write_agent:cp_data -> router_002:sink_data
	...
	wire  [149:0] router_002_src_data;                                                            // router_002:src_data -> cmd_demux_002:sink_data
	...
	wire  [113:0] sgdma_descriptor_read_agent_cp_data;                                            // sgdma_descriptor_read_agent:cp_data -> router_003:sink_data
	...
	wire  [113:0] sgdma_descriptor_write_agent_cp_data;                                           // sgdma_descriptor_write_agent:cp_data -> router_004:sink_data
	...
	wire  [113:0] sdram_s1_agent_rp_data;                                                         // sdram_s1_agent:rp_data -> router_005:sink_data
	...
	wire  [113:0] router_005_src_data;                                                            // router_005:src_data -> rsp_demux:sink_data
	...
	wire          pcie_ip_txs_agent_rp_valid;                                                     // pcie_ip_txs_agent:rp_valid -> router_006:sink_valid
	wire  [149:0] pcie_ip_txs_agent_rp_data;                                                      // pcie_ip_txs_agent:rp_data -> router_006:sink_data
	wire          pcie_ip_txs_agent_rp_ready;                                                     // router_006:sink_ready -> pcie_ip_txs_agent:rp_ready
	wire          pcie_ip_txs_agent_rp_startofpacket;                                             // pcie_ip_txs_agent:rp_startofpacket -> router_006:sink_startofpacket
	wire          pcie_ip_txs_agent_rp_endofpacket;                                               // pcie_ip_txs_agent:rp_endofpacket -> router_006:sink_endofpacket
	wire          router_006_src_valid;                                                           // router_006:src_valid -> rsp_demux_001:sink_valid
	wire  [149:0] router_006_src_data;                                                            // router_006:src_data -> rsp_demux_001:sink_data
	...
	wire  [149:0] router_001_src_data;                                                            // router_001:src_data -> sgdma_m_read_limiter:cmd_sink_data
	wire          router_001_src_ready;                                                           // sgdma_m_read_limiter:cmd_sink_ready -> router_001:src_ready
	wire    [4:0] router_001_src_channel;                                                         // router_001:src_channel -> sgdma_m_read_limiter:cmd_sink_channel
	...
	wire  [149:0] sgdma_m_read_limiter_cmd_src_data;                                              // sgdma_m_read_limiter:cmd_src_data -> cmd_demux_001:sink_data
	wire          sgdma_m_read_limiter_cmd_src_ready;                                             // cmd_demux_001:sink_ready -> sgdma_m_read_limiter:cmd_src_ready
	wire    [4:0] sgdma_m_read_limiter_cmd_src_channel;                                           // sgdma_m_read_limiter:cmd_src_channel -> cmd_demux_001:sink_channel
	...
	wire  [149:0] rsp_mux_001_src_data;                                                           // rsp_mux_001:src_data -> sgdma_m_read_limiter:rsp_sink_data
	wire          rsp_mux_001_src_ready;                                                          // sgdma_m_read_limiter:rsp_sink_ready -> rsp_mux_001:src_ready
	wire    [4:0] rsp_mux_001_src_channel;                                                        // rsp_mux_001:src_channel -> sgdma_m_read_limiter:rsp_sink_channel
	...
	wire    [4:0] cmd_mux_src_channel;                                                            // cmd_mux:src_channel -> sdram_s1_burst_adapter:sink0_channel
	...
	wire    [4:0] cmd_mux_001_src_channel;                                                        // cmd_mux_001:src_channel -> pcie_ip_txs_burst_adapter:sink0_channel
	...
	wire  [149:0] cmd_demux_001_src1_data;                                                        // cmd_demux_001:src1_data -> cmd_mux_001:sink0_data
	...
	wire  [149:0] cmd_demux_002_src1_data;                                                        // cmd_demux_002:src1_data -> cmd_mux_001:sink1_data
	...
	wire  [149:0] rsp_demux_001_src0_data;                                                        // rsp_demux_001:src0_data -> rsp_mux_001:sink1_data
	...
	wire  [149:0] rsp_demux_001_src1_data;                                                        // rsp_demux_001:src1_data -> rsp_mux_002:sink1_data
	...
	wire          cmd_demux_001_src0_valid;                                                       // cmd_demux_001:src0_valid -> sgdma_m_read_to_sdram_s1_cmd_width_adapter:in_valid
	wire  [149:0] cmd_demux_001_src0_data;                                                        // cmd_demux_001:src0_data -> sgdma_m_read_to_sdram_s1_cmd_width_adapter:in_data
	wire          cmd_demux_001_src0_ready;                                                       // sgdma_m_read_to_sdram_s1_cmd_width_adapter:in_ready -> cmd_demux_001:src0_ready
	wire    [4:0] cmd_demux_001_src0_channel;                                                     // cmd_demux_001:src0_channel -> sgdma_m_read_to_sdram_s1_cmd_width_adapter:in_channel
	wire          cmd_demux_001_src0_startofpacket;                                               // cmd_demux_001:src0_startofpacket -> sgdma_m_read_to_sdram_s1_cmd_width_adapter:in_startofpacket
	wire          cmd_demux_001_src0_endofpacket;                                                 // cmd_demux_001:src0_endofpacket -> sgdma_m_read_to_sdram_s1_cmd_width_adapter:in_endofpacket
	wire          cmd_demux_002_src0_valid;                                                       // cmd_demux_002:src0_valid -> sgdma_m_write_to_sdram_s1_cmd_width_adapter:in_valid
	wire  [149:0] cmd_demux_002_src0_data;                                                        // cmd_demux_002:src0_data -> sgdma_m_write_to_sdram_s1_cmd_width_adapter:in_data
	wire          cmd_demux_002_src0_ready;                                                       // sgdma_m_write_to_sdram_s1_cmd_width_adapter:in_ready -> cmd_demux_002:src0_ready
	wire    [4:0] cmd_demux_002_src0_channel;                                                     // cmd_demux_002:src0_channel -> sgdma_m_write_to_sdram_s1_cmd_width_adapter:in_channel
	wire          cmd_demux_002_src0_startofpacket;                                               // cmd_demux_002:src0_startofpacket -> sgdma_m_write_to_sdram_s1_cmd_width_adapter:in_startofpacket
	wire          cmd_demux_002_src0_endofpacket;                                                 // cmd_demux_002:src0_endofpacket -> sgdma_m_write_to_sdram_s1_cmd_width_adapter:in_endofpacket
	wire          cmd_demux_003_src0_valid;                                                       // cmd_demux_003:src0_valid -> sgdma_descriptor_read_to_pcie_ip_txs_cmd_width_adapter:in_valid
	wire  [113:0] cmd_demux_003_src0_data;                                                        // cmd_demux_003:src0_data -> sgdma_descriptor_read_to_pcie_ip_txs_cmd_width_adapter:in_data
	wire          cmd_demux_003_src0_ready;                                                       // sgdma_descriptor_read_to_pcie_ip_txs_cmd_width_adapter:in_ready -> cmd_demux_003:src0_ready
	wire    [4:0] cmd_demux_003_src0_channel;                                                     // cmd_demux_003:src0_channel -> sgdma_descriptor_read_to_pcie_ip_txs_cmd_width_adapter:in_channel
	...
	wire    [4:0] sgdma_descriptor_read_to_pcie_ip_txs_cmd_width_adapter_src_channel;             // sgdma_descriptor_read_to_pcie_ip_txs_cmd_width_adapter:out_channel -> cmd_mux_001:sink2_channel
	...
	wire  [113:0] cmd_demux_004_src0_data;                                                        // cmd_demux_004:src0_data -> sgdma_descriptor_write_to_pcie_ip_txs_cmd_width_adapter:in_data
	wire          cmd_demux_004_src0_ready;                                                       // sgdma_descriptor_write_to_pcie_ip_txs_cmd_width_adapter:in_ready -> cmd_demux_004:src0_ready
	wire    [4:0] cmd_demux_004_src0_channel;                                                     // cmd_demux_004:src0_channel -> sgdma_descriptor_write_to_pcie_ip_txs_cmd_width_adapter:in_channel
	...
	wire    [4:0] sgdma_descriptor_write_to_pcie_ip_txs_cmd_width_adapter_src_channel;            // sgdma_descriptor_write_to_pcie_ip_txs_cmd_width_adapter:out_channel -> cmd_mux_001:sink3_channel
	...
	wire          rsp_demux_src1_valid;                                                           // rsp_demux:src1_valid -> sdram_s1_to_sgdma_m_read_rsp_width_adapter:in_valid
	wire  [113:0] rsp_demux_src1_data;                                                            // rsp_demux:src1_data -> sdram_s1_to_sgdma_m_read_rsp_width_adapter:in_data
	wire          rsp_demux_src1_ready;                                                           // sdram_s1_to_sgdma_m_read_rsp_width_adapter:in_ready -> rsp_demux:src1_ready
	wire    [4:0] rsp_demux_src1_channel;                                                         // rsp_demux:src1_channel -> sdram_s1_to_sgdma_m_read_rsp_width_adapter:in_channel
	wire          rsp_demux_src1_startofpacket;                                                   // rsp_demux:src1_startofpacket -> sdram_s1_to_sgdma_m_read_rsp_width_adapter:in_startofpacket
	wire          rsp_demux_src1_endofpacket;                                                     // rsp_demux:src1_endofpacket -> sdram_s1_to_sgdma_m_read_rsp_width_adapter:in_endofpacket
	wire          rsp_demux_src2_valid;                                                           // rsp_demux:src2_valid -> sdram_s1_to_sgdma_m_write_rsp_width_adapter:in_valid
	wire  [113:0] rsp_demux_src2_data;                                                            // rsp_demux:src2_data -> sdram_s1_to_sgdma_m_write_rsp_width_adapter:in_data
	wire          rsp_demux_src2_ready;                                                           // sdram_s1_to_sgdma_m_write_rsp_width_adapter:in_ready -> rsp_demux:src2_ready
	wire    [4:0] rsp_demux_src2_channel;                                                         // rsp_demux:src2_channel -> sdram_s1_to_sgdma_m_write_rsp_width_adapter:in_channel
	wire          rsp_demux_src2_startofpacket;                                                   // rsp_demux:src2_startofpacket -> sdram_s1_to_sgdma_m_write_rsp_width_adapter:in_startofpacket
	wire          rsp_demux_src2_endofpacket;                                                     // rsp_demux:src2_endofpacket -> sdram_s1_to_sgdma_m_write_rsp_width_adapter:in_endofpacket
	...
	wire    [4:0] rsp_demux_001_src2_channel;                                                     // rsp_demux_001:src2_channel -> pcie_ip_txs_to_sgdma_descriptor_read_rsp_width_adapter:in_channel
	...
	wire  [113:0] pcie_ip_txs_to_sgdma_descriptor_read_rsp_width_adapter_src_data;                // pcie_ip_txs_to_sgdma_descriptor_read_rsp_width_adapter:out_data -> rsp_mux_003:sink0_data
	...
	wire    [4:0] pcie_ip_txs_to_sgdma_descriptor_read_rsp_width_adapter_src_channel;             // pcie_ip_txs_to_sgdma_descriptor_read_rsp_width_adapter:out_channel -> rsp_mux_003:sink0_channel
	...
	wire    [4:0] rsp_demux_001_src3_channel;                                                     // rsp_demux_001:src3_channel -> pcie_ip_txs_to_sgdma_descriptor_write_rsp_width_adapter:in_channel
	...
	wire  [113:0] pcie_ip_txs_to_sgdma_descriptor_write_rsp_width_adapter_src_data;               // pcie_ip_txs_to_sgdma_descriptor_write_rsp_width_adapter:out_data -> rsp_mux_004:sink0_data
	...
	wire    [4:0] pcie_ip_txs_to_sgdma_descriptor_write_rsp_width_adapter_src_channel;            // pcie_ip_txs_to_sgdma_descriptor_write_rsp_width_adapter:out_channel -> rsp_mux_004:sink0_channel
	...
	wire  [113:0] crosser_out_data;                                                               // crosser:out_data -> cmd_mux:sink1_data
	...
	wire  [113:0] crosser_001_out_data;                                                           // crosser_001:out_data -> cmd_mux:sink2_data
	...
	wire  [149:0] crosser_002_out_data;                                                           // crosser_002:out_data -> rsp_mux_001:sink0_data
	...
	wire  [149:0] crosser_003_out_data;                                                           // crosser_003:out_data -> rsp_mux_002:sink0_data
	...
	wire    [4:0] sgdma_m_read_limiter_cmd_valid_data;                                            // sgdma_m_read_limiter:cmd_src_valid -> cmd_demux_001:sink_valid
	...
	amm_master_qsys_with_pcie_mm_interconnect_0_router_003 router_003 (
	...
	amm_master_qsys_with_pcie_mm_interconnect_0_router_003 router_004 (
	...
	amm_master_qsys_with_pcie_mm_interconnect_0_router_005 router_005 (
	...
	amm_master_qsys_with_pcie_mm_interconnect_0_cmd_demux_003 cmd_demux_004 (
		.clk                (pcie_ip_pcie_core_clk_clk),               //       clk.clk
		.reset              (sgdma_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	amm_master_qsys_with_pcie_mm_interconnect_0_rsp_mux_001 rsp_mux_002 (
		.clk                 (pcie_ip_pcie_core_clk_clk),               //       clk.clk
		.reset               (sgdma_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	amm_master_qsys_with_pcie_mm_interconnect_0_rsp_mux rsp_mux_003 (
		.clk                 (pcie_ip_pcie_core_clk_clk),                                                //       clk.clk
		.reset               (sgdma_reset_reset_bridge_in_reset_reset),                                  // clk_reset.reset

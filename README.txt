...
The SimpleGPUIP folder has the following relevant files:
	source/AlphaBlender.sv			- Verilog code for the AlphaBlender module
	source/tb_AlphaBlender.sv		- Verilog test bench for the AlphaBlender module
	source/DrawLine.sv			- Verilog code for the DrawLine module
	source/tb_DrawLine.sv			- Verilog test bench for the DrawLine module
	source/GPU.sv				- Verilog code for the top level design file of the entire GPU module
	source/tb_GPU.sv			- Verilog test bench for the demonstrating the functionality of the GPU
	source/InputDecoder.sv			- Verilog code for the InputDecoder module
	source/tb_InputDecoder.sv		- Verilog test bench for the InputDecoder module
	source/InputDecoderRAM.sv		- A copy from the Altera RAM specification: http://www.altera.com/literature/hb/qts/qts_qii51007.pdf page 775
	source/InputDecoder_fifo_RAM.sv	- Verilog code for a fifo wrapper of the RAM (InputDecoder_fifo_RAM module)
	source/tb_InputDecoder_fifo_RAM.sv	- Verilog test bench for the InputDecoder_fifo_RAM module
	source/OutputController.sv		- Verilog code for the OutputController module
	source/tb_OutputController.sv		- Verilog test bench for the OutputController module
	source/OutputControllerRAM.sv		- A copy from the Altera RAM specification: http://www.altera.com/literature/hb/qts/qts_qii51007.pdf page 774
	source/Rasteriser.sv			- Verilog code for the Rasteriser module
	source/tb_Rasteriser.sv		- Verilog test bench for the Rasteriser module
	source/TextureController.sv		- Verilog code for the TextureController module
	source/tb_TextureController.sv		- Verilog test bench for the TextureController module
	source/TextureControllerRAM.sv		- A copy from the Altera RAM specification: http://www.altera.com/literature/hb/qts/qts_qii51007.pdf page 774
	source/flex_counter.sv			- Verilog code for the flex_counter module

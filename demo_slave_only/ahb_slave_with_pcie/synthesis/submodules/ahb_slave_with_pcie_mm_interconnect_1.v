// ahb_slave_with_pcie_mm_interconnect_1.v

// This file was auto-generated from altera_mm_interconnect_hw.tcl.  If you edit it your changes
// will probably be lost.
// 
// Generated using ACDS version 14.0 200 at 2016.04.18.21:09:39

`timescale 1 ps / 1 ps
module ahb_slave_with_pcie_mm_interconnect_1 (
	...
	wire  [111:0] rsp_mux_src_data;                                                          // rsp_mux:src_data -> sgdma_descriptor_read_agent:rp_data
	wire    [3:0] rsp_mux_src_channel;                                                       // rsp_mux:src_channel -> sgdma_descriptor_read_agent:rp_channel
	...
	wire  [111:0] rsp_mux_001_src_data;                                                      // rsp_mux_001:src_data -> sgdma_descriptor_write_agent:rp_data
	wire    [3:0] rsp_mux_001_src_channel;                                                   // rsp_mux_001:src_channel -> sgdma_descriptor_write_agent:rp_channel
	...
	wire  [147:0] rsp_mux_003_src_data;                                                      // rsp_mux_003:src_data -> sgdma_m_write_agent:rp_data
	wire    [3:0] rsp_mux_003_src_channel;                                                   // rsp_mux_003:src_channel -> sgdma_m_write_agent:rp_channel
	...
	wire  [148:0] pcie_ip_txs_agent_rf_source_data;                                          // pcie_ip_txs_agent:rf_source_data -> pcie_ip_txs_agent_rsp_fifo:in_data
	...
	wire  [148:0] pcie_ip_txs_agent_rsp_fifo_out_data;                                       // pcie_ip_txs_agent_rsp_fifo:out_data -> pcie_ip_txs_agent:rf_sink_data
	...
	wire  [111:0] sgdma_descriptor_read_agent_cp_data;                                       // sgdma_descriptor_read_agent:cp_data -> router:sink_data
	...
	wire  [111:0] sgdma_descriptor_write_agent_cp_data;                                      // sgdma_descriptor_write_agent:cp_data -> router_001:sink_data
	...
	wire  [147:0] sgdma_m_read_agent_cp_data;                                                // sgdma_m_read_agent:cp_data -> router_002:sink_data
	...
	wire  [147:0] sgdma_m_write_agent_cp_data;                                               // sgdma_m_write_agent:cp_data -> router_003:sink_data
	...
	wire  [147:0] router_003_src_data;                                                       // router_003:src_data -> cmd_demux_003:sink_data
	...
	wire  [147:0] pcie_ip_txs_agent_rp_data;                                                 // pcie_ip_txs_agent:rp_data -> router_004:sink_data
	...
	wire  [147:0] router_004_src_data;                                                       // router_004:src_data -> rsp_demux:sink_data
	...
	wire  [111:0] sdram_s1_agent_rp_data;                                                    // sdram_s1_agent:rp_data -> router_005:sink_data
	...
	wire  [147:0] router_002_src_data;                                                       // router_002:src_data -> sgdma_m_read_limiter:cmd_sink_data
	wire    [3:0] router_002_src_channel;                                                    // router_002:src_channel -> sgdma_m_read_limiter:cmd_sink_channel
	...
	wire  [147:0] sgdma_m_read_limiter_cmd_src_data;                                         // sgdma_m_read_limiter:cmd_src_data -> cmd_demux_002:sink_data
	wire    [3:0] sgdma_m_read_limiter_cmd_src_channel;                                      // sgdma_m_read_limiter:cmd_src_channel -> cmd_demux_002:sink_channel
	...
	wire  [147:0] rsp_mux_002_src_data;                                                      // rsp_mux_002:src_data -> sgdma_m_read_limiter:rsp_sink_data
	wire    [3:0] rsp_mux_002_src_channel;                                                   // rsp_mux_002:src_channel -> sgdma_m_read_limiter:rsp_sink_channel
	...
	wire  [147:0] sgdma_m_read_limiter_rsp_src_data;                                         // sgdma_m_read_limiter:rsp_src_data -> sgdma_m_read_agent:rp_data
	wire    [3:0] sgdma_m_read_limiter_rsp_src_channel;                                      // sgdma_m_read_limiter:rsp_src_channel -> sgdma_m_read_agent:rp_channel
	...
	wire  [147:0] cmd_mux_src_data;                                                          // cmd_mux:src_data -> pcie_ip_txs_burst_adapter:sink0_data
	wire    [3:0] cmd_mux_src_channel;                                                       // cmd_mux:src_channel -> pcie_ip_txs_burst_adapter:sink0_channel
	...
	wire  [147:0] pcie_ip_txs_burst_adapter_source0_data;                                    // pcie_ip_txs_burst_adapter:source0_data -> pcie_ip_txs_agent:cp_data
	wire          pcie_ip_txs_burst_adapter_source0_ready;                                   // pcie_ip_txs_agent:cp_ready -> pcie_ip_txs_burst_adapter:source0_ready
	wire    [3:0] pcie_ip_txs_burst_adapter_source0_channel;                                 // pcie_ip_txs_burst_adapter:source0_channel -> pcie_ip_txs_agent:cp_channel
	...
	wire  [111:0] cmd_mux_001_src_data;                                                      // cmd_mux_001:src_data -> sdram_s1_burst_adapter:sink0_data
	...
	wire  [111:0] cmd_mux_002_src_data;                                                      // cmd_mux_002:src_data -> onchip_memory2_0_s1_burst_adapter:sink0_data
	...
	wire  [147:0] cmd_demux_003_src0_data;                                                   // cmd_demux_003:src0_data -> cmd_mux:sink3_data
	...
	wire  [147:0] rsp_demux_src3_data;                                                       // rsp_demux:src3_data -> rsp_mux_003:sink0_data
	...
	wire  [111:0] cmd_demux_src0_data;                                                       // cmd_demux:src0_data -> sgdma_descriptor_read_to_pcie_ip_txs_cmd_width_adapter:in_data
	wire    [3:0] cmd_demux_src0_channel;                                                    // cmd_demux:src0_channel -> sgdma_descriptor_read_to_pcie_ip_txs_cmd_width_adapter:in_channel
	...
	wire  [147:0] sgdma_descriptor_read_to_pcie_ip_txs_cmd_width_adapter_src_data;           // sgdma_descriptor_read_to_pcie_ip_txs_cmd_width_adapter:out_data -> cmd_mux:sink0_data
	...
	wire    [3:0] sgdma_descriptor_read_to_pcie_ip_txs_cmd_width_adapter_src_channel;        // sgdma_descriptor_read_to_pcie_ip_txs_cmd_width_adapter:out_channel -> cmd_mux:sink0_channel
	...
	wire  [111:0] cmd_demux_001_src0_data;                                                   // cmd_demux_001:src0_data -> sgdma_descriptor_write_to_pcie_ip_txs_cmd_width_adapter:in_data
	wire    [3:0] cmd_demux_001_src0_channel;                                                // cmd_demux_001:src0_channel -> sgdma_descriptor_write_to_pcie_ip_txs_cmd_width_adapter:in_channel
	...
	wire  [147:0] sgdma_descriptor_write_to_pcie_ip_txs_cmd_width_adapter_src_data;          // sgdma_descriptor_write_to_pcie_ip_txs_cmd_width_adapter:out_data -> cmd_mux:sink1_data
	...
	wire    [3:0] sgdma_descriptor_write_to_pcie_ip_txs_cmd_width_adapter_src_channel;       // sgdma_descriptor_write_to_pcie_ip_txs_cmd_width_adapter:out_channel -> cmd_mux:sink1_channel
	...
	wire  [147:0] cmd_demux_002_src1_data;                                                   // cmd_demux_002:src1_data -> sgdma_m_read_to_sdram_s1_cmd_width_adapter:in_data
	wire    [3:0] cmd_demux_002_src1_channel;                                                // cmd_demux_002:src1_channel -> sgdma_m_read_to_sdram_s1_cmd_width_adapter:in_channel
	wire          cmd_demux_002_src1_ready;                                                  // sgdma_m_read_to_sdram_s1_cmd_width_adapter:in_ready -> cmd_demux_002:src1_ready
	wire          cmd_demux_002_src2_endofpacket;                                            // cmd_demux_002:src2_endofpacket -> sgdma_m_read_to_onchip_memory2_0_s1_cmd_width_adapter:in_endofpacket
	wire          cmd_demux_002_src2_valid;                                                  // cmd_demux_002:src2_valid -> sgdma_m_read_to_onchip_memory2_0_s1_cmd_width_adapter:in_valid
	wire          cmd_demux_002_src2_startofpacket;                                          // cmd_demux_002:src2_startofpacket -> sgdma_m_read_to_onchip_memory2_0_s1_cmd_width_adapter:in_startofpacket
	wire  [147:0] cmd_demux_002_src2_data;                                                   // cmd_demux_002:src2_data -> sgdma_m_read_to_onchip_memory2_0_s1_cmd_width_adapter:in_data
	wire    [3:0] cmd_demux_002_src2_channel;                                                // cmd_demux_002:src2_channel -> sgdma_m_read_to_onchip_memory2_0_s1_cmd_width_adapter:in_channel
	wire          cmd_demux_002_src2_ready;                                                  // sgdma_m_read_to_onchip_memory2_0_s1_cmd_width_adapter:in_ready -> cmd_demux_002:src2_ready
	...
	wire  [147:0] cmd_demux_003_src1_data;                                                   // cmd_demux_003:src1_data -> sgdma_m_write_to_sdram_s1_cmd_width_adapter:in_data
	wire    [3:0] cmd_demux_003_src1_channel;                                                // cmd_demux_003:src1_channel -> sgdma_m_write_to_sdram_s1_cmd_width_adapter:in_channel
	wire          cmd_demux_003_src1_ready;                                                  // sgdma_m_write_to_sdram_s1_cmd_width_adapter:in_ready -> cmd_demux_003:src1_ready
	wire          cmd_demux_003_src2_endofpacket;                                            // cmd_demux_003:src2_endofpacket -> sgdma_m_write_to_onchip_memory2_0_s1_cmd_width_adapter:in_endofpacket
	wire          cmd_demux_003_src2_valid;                                                  // cmd_demux_003:src2_valid -> sgdma_m_write_to_onchip_memory2_0_s1_cmd_width_adapter:in_valid
	wire          cmd_demux_003_src2_startofpacket;                                          // cmd_demux_003:src2_startofpacket -> sgdma_m_write_to_onchip_memory2_0_s1_cmd_width_adapter:in_startofpacket
	wire  [147:0] cmd_demux_003_src2_data;                                                   // cmd_demux_003:src2_data -> sgdma_m_write_to_onchip_memory2_0_s1_cmd_width_adapter:in_data
	wire    [3:0] cmd_demux_003_src2_channel;                                                // cmd_demux_003:src2_channel -> sgdma_m_write_to_onchip_memory2_0_s1_cmd_width_adapter:in_channel
	wire          cmd_demux_003_src2_ready;                                                  // sgdma_m_write_to_onchip_memory2_0_s1_cmd_width_adapter:in_ready -> cmd_demux_003:src2_ready
	...
	wire  [147:0] rsp_demux_src0_data;                                                       // rsp_demux:src0_data -> pcie_ip_txs_to_sgdma_descriptor_read_rsp_width_adapter:in_data
	wire    [3:0] rsp_demux_src0_channel;                                                    // rsp_demux:src0_channel -> pcie_ip_txs_to_sgdma_descriptor_read_rsp_width_adapter:in_channel
	...
	wire  [111:0] pcie_ip_txs_to_sgdma_descriptor_read_rsp_width_adapter_src_data;           // pcie_ip_txs_to_sgdma_descriptor_read_rsp_width_adapter:out_data -> rsp_mux:sink0_data
	...
	wire    [3:0] pcie_ip_txs_to_sgdma_descriptor_read_rsp_width_adapter_src_channel;        // pcie_ip_txs_to_sgdma_descriptor_read_rsp_width_adapter:out_channel -> rsp_mux:sink0_channel
	...
	wire  [147:0] rsp_demux_src1_data;                                                       // rsp_demux:src1_data -> pcie_ip_txs_to_sgdma_descriptor_write_rsp_width_adapter:in_data
	wire    [3:0] rsp_demux_src1_channel;                                                    // rsp_demux:src1_channel -> pcie_ip_txs_to_sgdma_descriptor_write_rsp_width_adapter:in_channel
	...
	wire  [111:0] pcie_ip_txs_to_sgdma_descriptor_write_rsp_width_adapter_src_data;          // pcie_ip_txs_to_sgdma_descriptor_write_rsp_width_adapter:out_data -> rsp_mux_001:sink0_data
	...
	wire    [3:0] pcie_ip_txs_to_sgdma_descriptor_write_rsp_width_adapter_src_channel;       // pcie_ip_txs_to_sgdma_descriptor_write_rsp_width_adapter:out_channel -> rsp_mux_001:sink0_channel
	...
	wire  [111:0] rsp_demux_001_src0_data;                                                   // rsp_demux_001:src0_data -> sdram_s1_to_sgdma_m_read_rsp_width_adapter:in_data
	wire    [3:0] rsp_demux_001_src0_channel;                                                // rsp_demux_001:src0_channel -> sdram_s1_to_sgdma_m_read_rsp_width_adapter:in_channel
	...
	wire  [111:0] rsp_demux_001_src1_data;                                                   // rsp_demux_001:src1_data -> sdram_s1_to_sgdma_m_write_rsp_width_adapter:in_data
	wire    [3:0] rsp_demux_001_src1_channel;                                                // rsp_demux_001:src1_channel -> sdram_s1_to_sgdma_m_write_rsp_width_adapter:in_channel
	wire          rsp_demux_001_src1_ready;                                                  // sdram_s1_to_sgdma_m_write_rsp_width_adapter:in_ready -> rsp_demux_001:src1_ready
	wire          rsp_demux_002_src0_endofpacket;                                            // rsp_demux_002:src0_endofpacket -> onchip_memory2_0_s1_to_sgdma_m_read_rsp_width_adapter:in_endofpacket
	wire          rsp_demux_002_src0_valid;                                                  // rsp_demux_002:src0_valid -> onchip_memory2_0_s1_to_sgdma_m_read_rsp_width_adapter:in_valid
	wire          rsp_demux_002_src0_startofpacket;                                          // rsp_demux_002:src0_startofpacket -> onchip_memory2_0_s1_to_sgdma_m_read_rsp_width_adapter:in_startofpacket
	wire  [111:0] rsp_demux_002_src0_data;                                                   // rsp_demux_002:src0_data -> onchip_memory2_0_s1_to_sgdma_m_read_rsp_width_adapter:in_data
	wire    [3:0] rsp_demux_002_src0_channel;                                                // rsp_demux_002:src0_channel -> onchip_memory2_0_s1_to_sgdma_m_read_rsp_width_adapter:in_channel
	wire          rsp_demux_002_src0_ready;                                                  // onchip_memory2_0_s1_to_sgdma_m_read_rsp_width_adapter:in_ready -> rsp_demux_002:src0_ready
	wire          rsp_demux_002_src1_endofpacket;                                            // rsp_demux_002:src1_endofpacket -> onchip_memory2_0_s1_to_sgdma_m_write_rsp_width_adapter:in_endofpacket
	wire          rsp_demux_002_src1_valid;                                                  // rsp_demux_002:src1_valid -> onchip_memory2_0_s1_to_sgdma_m_write_rsp_width_adapter:in_valid
	wire          rsp_demux_002_src1_startofpacket;                                          // rsp_demux_002:src1_startofpacket -> onchip_memory2_0_s1_to_sgdma_m_write_rsp_width_adapter:in_startofpacket
	wire  [111:0] rsp_demux_002_src1_data;                                                   // rsp_demux_002:src1_data -> onchip_memory2_0_s1_to_sgdma_m_write_rsp_width_adapter:in_data
	wire    [3:0] rsp_demux_002_src1_channel;                                                // rsp_demux_002:src1_channel -> onchip_memory2_0_s1_to_sgdma_m_write_rsp_width_adapter:in_channel
	wire          rsp_demux_002_src1_ready;                                                  // onchip_memory2_0_s1_to_sgdma_m_write_rsp_width_adapter:in_ready -> rsp_demux_002:src1_ready
	...
	wire  [111:0] sgdma_m_read_to_sdram_s1_cmd_width_adapter_src_data;                       // sgdma_m_read_to_sdram_s1_cmd_width_adapter:out_data -> crosser:in_data
	...
	wire    [3:0] sgdma_m_read_to_sdram_s1_cmd_width_adapter_src_channel;                    // sgdma_m_read_to_sdram_s1_cmd_width_adapter:out_channel -> crosser:in_channel
	...
	wire          sgdma_m_read_to_onchip_memory2_0_s1_cmd_width_adapter_src_endofpacket;     // sgdma_m_read_to_onchip_memory2_0_s1_cmd_width_adapter:out_endofpacket -> crosser_001:in_endofpacket
	wire          sgdma_m_read_to_onchip_memory2_0_s1_cmd_width_adapter_src_valid;           // sgdma_m_read_to_onchip_memory2_0_s1_cmd_width_adapter:out_valid -> crosser_001:in_valid
	wire          sgdma_m_read_to_onchip_memory2_0_s1_cmd_width_adapter_src_startofpacket;   // sgdma_m_read_to_onchip_memory2_0_s1_cmd_width_adapter:out_startofpacket -> crosser_001:in_startofpacket
	wire  [111:0] sgdma_m_read_to_onchip_memory2_0_s1_cmd_width_adapter_src_data;            // sgdma_m_read_to_onchip_memory2_0_s1_cmd_width_adapter:out_data -> crosser_001:in_data
	wire          sgdma_m_read_to_onchip_memory2_0_s1_cmd_width_adapter_src_ready;           // crosser_001:in_ready -> sgdma_m_read_to_onchip_memory2_0_s1_cmd_width_adapter:out_ready
	wire    [3:0] sgdma_m_read_to_onchip_memory2_0_s1_cmd_width_adapter_src_channel;         // sgdma_m_read_to_onchip_memory2_0_s1_cmd_width_adapter:out_channel -> crosser_001:in_channel
	...
	wire  [111:0] crosser_001_out_data;                                                      // crosser_001:out_data -> cmd_mux_002:sink0_data
	...
	wire          sgdma_m_write_to_sdram_s1_cmd_width_adapter_src_endofpacket;               // sgdma_m_write_to_sdram_s1_cmd_width_adapter:out_endofpacket -> crosser_002:in_endofpacket
	wire          sgdma_m_write_to_sdram_s1_cmd_width_adapter_src_valid;                     // sgdma_m_write_to_sdram_s1_cmd_width_adapter:out_valid -> crosser_002:in_valid
	wire          sgdma_m_write_to_sdram_s1_cmd_width_adapter_src_startofpacket;             // sgdma_m_write_to_sdram_s1_cmd_width_adapter:out_startofpacket -> crosser_002:in_startofpacket
	wire  [111:0] sgdma_m_write_to_sdram_s1_cmd_width_adapter_src_data;                      // sgdma_m_write_to_sdram_s1_cmd_width_adapter:out_data -> crosser_002:in_data
	wire          sgdma_m_write_to_sdram_s1_cmd_width_adapter_src_ready;                     // crosser_002:in_ready -> sgdma_m_write_to_sdram_s1_cmd_width_adapter:out_ready
	wire    [3:0] sgdma_m_write_to_sdram_s1_cmd_width_adapter_src_channel;                   // sgdma_m_write_to_sdram_s1_cmd_width_adapter:out_channel -> crosser_002:in_channel
	...
	wire          sgdma_m_write_to_onchip_memory2_0_s1_cmd_width_adapter_src_endofpacket;    // sgdma_m_write_to_onchip_memory2_0_s1_cmd_width_adapter:out_endofpacket -> crosser_003:in_endofpacket
	wire          sgdma_m_write_to_onchip_memory2_0_s1_cmd_width_adapter_src_valid;          // sgdma_m_write_to_onchip_memory2_0_s1_cmd_width_adapter:out_valid -> crosser_003:in_valid
	wire          sgdma_m_write_to_onchip_memory2_0_s1_cmd_width_adapter_src_startofpacket;  // sgdma_m_write_to_onchip_memory2_0_s1_cmd_width_adapter:out_startofpacket -> crosser_003:in_startofpacket
	wire  [111:0] sgdma_m_write_to_onchip_memory2_0_s1_cmd_width_adapter_src_data;           // sgdma_m_write_to_onchip_memory2_0_s1_cmd_width_adapter:out_data -> crosser_003:in_data
	wire          sgdma_m_write_to_onchip_memory2_0_s1_cmd_width_adapter_src_ready;          // crosser_003:in_ready -> sgdma_m_write_to_onchip_memory2_0_s1_cmd_width_adapter:out_ready
	wire    [3:0] sgdma_m_write_to_onchip_memory2_0_s1_cmd_width_adapter_src_channel;        // sgdma_m_write_to_onchip_memory2_0_s1_cmd_width_adapter:out_channel -> crosser_003:in_channel
	...
	wire  [111:0] crosser_003_out_data;                                                      // crosser_003:out_data -> cmd_mux_002:sink1_data
	...
	wire          sdram_s1_to_sgdma_m_read_rsp_width_adapter_src_endofpacket;                // sdram_s1_to_sgdma_m_read_rsp_width_adapter:out_endofpacket -> crosser_004:in_endofpacket
	wire          sdram_s1_to_sgdma_m_read_rsp_width_adapter_src_valid;                      // sdram_s1_to_sgdma_m_read_rsp_width_adapter:out_valid -> crosser_004:in_valid
	wire          sdram_s1_to_sgdma_m_read_rsp_width_adapter_src_startofpacket;              // sdram_s1_to_sgdma_m_read_rsp_width_adapter:out_startofpacket -> crosser_004:in_startofpacket
	wire  [147:0] sdram_s1_to_sgdma_m_read_rsp_width_adapter_src_data;                       // sdram_s1_to_sgdma_m_read_rsp_width_adapter:out_data -> crosser_004:in_data
	wire          sdram_s1_to_sgdma_m_read_rsp_width_adapter_src_ready;                      // crosser_004:in_ready -> sdram_s1_to_sgdma_m_read_rsp_width_adapter:out_ready
	wire    [3:0] sdram_s1_to_sgdma_m_read_rsp_width_adapter_src_channel;                    // sdram_s1_to_sgdma_m_read_rsp_width_adapter:out_channel -> crosser_004:in_channel
	wire          crosser_004_out_endofpacket;                                               // crosser_004:out_endofpacket -> rsp_mux_002:sink1_endofpacket
	wire          crosser_004_out_valid;                                                     // crosser_004:out_valid -> rsp_mux_002:sink1_valid
	wire          crosser_004_out_startofpacket;                                             // crosser_004:out_startofpacket -> rsp_mux_002:sink1_startofpacket
	wire  [147:0] crosser_004_out_data;                                                      // crosser_004:out_data -> rsp_mux_002:sink1_data
	wire    [3:0] crosser_004_out_channel;                                                   // crosser_004:out_channel -> rsp_mux_002:sink1_channel
	wire          crosser_004_out_ready;                                                     // rsp_mux_002:sink1_ready -> crosser_004:out_ready
	wire          sdram_s1_to_sgdma_m_write_rsp_width_adapter_src_endofpacket;               // sdram_s1_to_sgdma_m_write_rsp_width_adapter:out_endofpacket -> crosser_005:in_endofpacket
	wire          sdram_s1_to_sgdma_m_write_rsp_width_adapter_src_valid;                     // sdram_s1_to_sgdma_m_write_rsp_width_adapter:out_valid -> crosser_005:in_valid
	wire          sdram_s1_to_sgdma_m_write_rsp_width_adapter_src_startofpacket;             // sdram_s1_to_sgdma_m_write_rsp_width_adapter:out_startofpacket -> crosser_005:in_startofpacket
	wire  [147:0] sdram_s1_to_sgdma_m_write_rsp_width_adapter_src_data;                      // sdram_s1_to_sgdma_m_write_rsp_width_adapter:out_data -> crosser_005:in_data
	wire          sdram_s1_to_sgdma_m_write_rsp_width_adapter_src_ready;                     // crosser_005:in_ready -> sdram_s1_to_sgdma_m_write_rsp_width_adapter:out_ready
	wire    [3:0] sdram_s1_to_sgdma_m_write_rsp_width_adapter_src_channel;                   // sdram_s1_to_sgdma_m_write_rsp_width_adapter:out_channel -> crosser_005:in_channel
	...
	wire  [147:0] crosser_005_out_data;                                                      // crosser_005:out_data -> rsp_mux_003:sink1_data
	wire    [3:0] crosser_005_out_channel;                                                   // crosser_005:out_channel -> rsp_mux_003:sink1_channel
	wire          crosser_005_out_ready;                                                     // rsp_mux_003:sink1_ready -> crosser_005:out_ready
	wire          onchip_memory2_0_s1_to_sgdma_m_read_rsp_width_adapter_src_endofpacket;     // onchip_memory2_0_s1_to_sgdma_m_read_rsp_width_adapter:out_endofpacket -> crosser_006:in_endofpacket
	wire          onchip_memory2_0_s1_to_sgdma_m_read_rsp_width_adapter_src_valid;           // onchip_memory2_0_s1_to_sgdma_m_read_rsp_width_adapter:out_valid -> crosser_006:in_valid
	wire          onchip_memory2_0_s1_to_sgdma_m_read_rsp_width_adapter_src_startofpacket;   // onchip_memory2_0_s1_to_sgdma_m_read_rsp_width_adapter:out_startofpacket -> crosser_006:in_startofpacket
	wire  [147:0] onchip_memory2_0_s1_to_sgdma_m_read_rsp_width_adapter_src_data;            // onchip_memory2_0_s1_to_sgdma_m_read_rsp_width_adapter:out_data -> crosser_006:in_data
	wire          onchip_memory2_0_s1_to_sgdma_m_read_rsp_width_adapter_src_ready;           // crosser_006:in_ready -> onchip_memory2_0_s1_to_sgdma_m_read_rsp_width_adapter:out_ready
	wire    [3:0] onchip_memory2_0_s1_to_sgdma_m_read_rsp_width_adapter_src_channel;         // onchip_memory2_0_s1_to_sgdma_m_read_rsp_width_adapter:out_channel -> crosser_006:in_channel
	wire          crosser_006_out_endofpacket;                                               // crosser_006:out_endofpacket -> rsp_mux_002:sink2_endofpacket
	wire          crosser_006_out_valid;                                                     // crosser_006:out_valid -> rsp_mux_002:sink2_valid
	wire          crosser_006_out_startofpacket;                                             // crosser_006:out_startofpacket -> rsp_mux_002:sink2_startofpacket
	wire  [147:0] crosser_006_out_data;                                                      // crosser_006:out_data -> rsp_mux_002:sink2_data
	wire    [3:0] crosser_006_out_channel;                                                   // crosser_006:out_channel -> rsp_mux_002:sink2_channel
	wire          crosser_006_out_ready;                                                     // rsp_mux_002:sink2_ready -> crosser_006:out_ready
	wire          onchip_memory2_0_s1_to_sgdma_m_write_rsp_width_adapter_src_endofpacket;    // onchip_memory2_0_s1_to_sgdma_m_write_rsp_width_adapter:out_endofpacket -> crosser_007:in_endofpacket
	wire          onchip_memory2_0_s1_to_sgdma_m_write_rsp_width_adapter_src_valid;          // onchip_memory2_0_s1_to_sgdma_m_write_rsp_width_adapter:out_valid -> crosser_007:in_valid
	wire          onchip_memory2_0_s1_to_sgdma_m_write_rsp_width_adapter_src_startofpacket;  // onchip_memory2_0_s1_to_sgdma_m_write_rsp_width_adapter:out_startofpacket -> crosser_007:in_startofpacket
	wire  [147:0] onchip_memory2_0_s1_to_sgdma_m_write_rsp_width_adapter_src_data;           // onchip_memory2_0_s1_to_sgdma_m_write_rsp_width_adapter:out_data -> crosser_007:in_data
	wire          onchip_memory2_0_s1_to_sgdma_m_write_rsp_width_adapter_src_ready;          // crosser_007:in_ready -> onchip_memory2_0_s1_to_sgdma_m_write_rsp_width_adapter:out_ready
	wire    [3:0] onchip_memory2_0_s1_to_sgdma_m_write_rsp_width_adapter_src_channel;        // onchip_memory2_0_s1_to_sgdma_m_write_rsp_width_adapter:out_channel -> crosser_007:in_channel
	wire          crosser_007_out_endofpacket;                                               // crosser_007:out_endofpacket -> rsp_mux_003:sink2_endofpacket
	wire          crosser_007_out_valid;                                                     // crosser_007:out_valid -> rsp_mux_003:sink2_valid
	wire          crosser_007_out_startofpacket;                                             // crosser_007:out_startofpacket -> rsp_mux_003:sink2_startofpacket
	wire  [147:0] crosser_007_out_data;                                                      // crosser_007:out_data -> rsp_mux_003:sink2_data
	wire    [3:0] crosser_007_out_channel;                                                   // crosser_007:out_channel -> rsp_mux_003:sink2_channel
	wire          crosser_007_out_ready;                                                     // rsp_mux_003:sink2_ready -> crosser_007:out_ready
	wire    [3:0] sgdma_m_read_limiter_cmd_valid_data;                                       // sgdma_m_read_limiter:cmd_src_valid -> cmd_demux_002:sink_valid
	...
	ahb_slave_with_pcie_mm_interconnect_1_router router (
	...
	ahb_slave_with_pcie_mm_interconnect_1_router router_001 (
	...
	ahb_slave_with_pcie_mm_interconnect_1_router_002 router_002 (
	...
	ahb_slave_with_pcie_mm_interconnect_1_router_002 router_003 (
	...
	ahb_slave_with_pcie_mm_interconnect_1_router_004 router_004 (
	...
	ahb_slave_with_pcie_mm_interconnect_1_router_005 router_005 (
	...
	ahb_slave_with_pcie_mm_interconnect_1_router_005 router_006 (
	...
	ahb_slave_with_pcie_mm_interconnect_1_cmd_demux cmd_demux (
		.clk                (pcie_ip_pcie_core_clk_clk),               //       clk.clk
		.reset              (sgdma_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	ahb_slave_with_pcie_mm_interconnect_1_cmd_demux cmd_demux_001 (
		.clk                (pcie_ip_pcie_core_clk_clk),               //       clk.clk
		.reset              (sgdma_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	ahb_slave_with_pcie_mm_interconnect_1_cmd_demux_002 cmd_demux_002 (
		.clk                (pcie_ip_pcie_core_clk_clk),                  //        clk.clk
		.reset              (sgdma_reset_reset_bridge_in_reset_reset),    //  clk_reset.reset
	...
	ahb_slave_with_pcie_mm_interconnect_1_cmd_demux_003 cmd_demux_003 (
		.clk                (pcie_ip_pcie_core_clk_clk),               //       clk.clk
		.reset              (sgdma_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	ahb_slave_with_pcie_mm_interconnect_1_cmd_mux cmd_mux (
		.clk                 (pcie_ip_pcie_core_clk_clk),                                                 //       clk.clk
		.reset               (pcie_ip_txs_translator_reset_reset_bridge_in_reset_reset),                  // clk_reset.reset
	...
	ahb_slave_with_pcie_mm_interconnect_1_cmd_mux_001 cmd_mux_001 (
		.clk                 (clk_50_clk_clk),                          //       clk.clk
		.reset               (sdram_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	ahb_slave_with_pcie_mm_interconnect_1_cmd_mux_002 cmd_mux_002 (
		.clk                 (clk_50_clk_clk),                                      //       clk.clk
		.reset               (onchip_memory2_0_reset1_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	ahb_slave_with_pcie_mm_interconnect_1_rsp_demux rsp_demux (
		.clk                (pcie_ip_pcie_core_clk_clk),                                //       clk.clk
		.reset              (pcie_ip_txs_translator_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	ahb_slave_with_pcie_mm_interconnect_1_rsp_demux_001 rsp_demux_001 (
		.clk                (clk_50_clk_clk),                          //       clk.clk
		.reset              (sdram_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	ahb_slave_with_pcie_mm_interconnect_1_rsp_demux_001 rsp_demux_002 (
		.clk                (clk_50_clk_clk),                                      //       clk.clk
		.reset              (onchip_memory2_0_reset1_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	ahb_slave_with_pcie_mm_interconnect_1_rsp_mux rsp_mux (
		.clk                 (pcie_ip_pcie_core_clk_clk),                                                //       clk.clk
		.reset               (sgdma_reset_reset_bridge_in_reset_reset),                                  // clk_reset.reset
	...
	ahb_slave_with_pcie_mm_interconnect_1_rsp_mux rsp_mux_001 (
		.clk                 (pcie_ip_pcie_core_clk_clk),                                                 //       clk.clk
		.reset               (sgdma_reset_reset_bridge_in_reset_reset),                                   // clk_reset.reset
	...
	ahb_slave_with_pcie_mm_interconnect_1_rsp_mux_002 rsp_mux_002 (
		.clk                 (pcie_ip_pcie_core_clk_clk),               //       clk.clk
		.reset               (sgdma_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	ahb_slave_with_pcie_mm_interconnect_1_rsp_mux_002 rsp_mux_003 (
		.clk                 (pcie_ip_pcie_core_clk_clk),               //       clk.clk
		.reset               (sgdma_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	altera_merlin_width_adapter #(
		...
		.PACKING                       (1),
		.ENABLE_ADDRESS_ALIGNMENT      (0)
	) sgdma_m_read_to_onchip_memory2_0_s1_cmd_width_adapter (
		.clk                  (pcie_ip_pcie_core_clk_clk),                                               //       clk.clk
		.reset                (sgdma_reset_reset_bridge_in_reset_reset),                                 // clk_reset.reset
		...
		.out_endofpacket      (sgdma_m_read_to_onchip_memory2_0_s1_cmd_width_adapter_src_endofpacket),   //       src.endofpacket
		.out_data             (sgdma_m_read_to_onchip_memory2_0_s1_cmd_width_adapter_src_data),          //          .data
		.out_channel          (sgdma_m_read_to_onchip_memory2_0_s1_cmd_width_adapter_src_channel),       //          .channel
		.out_valid            (sgdma_m_read_to_onchip_memory2_0_s1_cmd_width_adapter_src_valid),         //          .valid
		.out_ready            (sgdma_m_read_to_onchip_memory2_0_s1_cmd_width_adapter_src_ready),         //          .ready
		.out_startofpacket    (sgdma_m_read_to_onchip_memory2_0_s1_cmd_width_adapter_src_startofpacket), //          .startofpacket
		.in_command_size_data (3'b000)                                                                   // (terminated)
	);
	...
	altera_merlin_width_adapter #(
		...
		.PACKING                       (1),
		.ENABLE_ADDRESS_ALIGNMENT      (0)
	) sgdma_m_write_to_onchip_memory2_0_s1_cmd_width_adapter (
		.clk                  (pcie_ip_pcie_core_clk_clk),                                                //       clk.clk
		.reset                (sgdma_reset_reset_bridge_in_reset_reset),                                  // clk_reset.reset
		...
		.out_endofpacket      (sgdma_m_write_to_onchip_memory2_0_s1_cmd_width_adapter_src_endofpacket),   //       src.endofpacket
		.out_data             (sgdma_m_write_to_onchip_memory2_0_s1_cmd_width_adapter_src_data),          //          .data
		.out_channel          (sgdma_m_write_to_onchip_memory2_0_s1_cmd_width_adapter_src_channel),       //          .channel
		.out_valid            (sgdma_m_write_to_onchip_memory2_0_s1_cmd_width_adapter_src_valid),         //          .valid
		.out_ready            (sgdma_m_write_to_onchip_memory2_0_s1_cmd_width_adapter_src_ready),         //          .ready
		.out_startofpacket    (sgdma_m_write_to_onchip_memory2_0_s1_cmd_width_adapter_src_startofpacket), //          .startofpacket
		.in_command_size_data (3'b000)                                                                    // (terminated)
	);
	...
	altera_merlin_width_adapter #(
		...
		.PACKING                       (1),
		.ENABLE_ADDRESS_ALIGNMENT      (0)
	) onchip_memory2_0_s1_to_sgdma_m_read_rsp_width_adapter (
		.clk                  (clk_50_clk_clk),                                                          //       clk.clk
		.reset                (onchip_memory2_0_reset1_reset_bridge_in_reset_reset),                     // clk_reset.reset
		...
		.out_endofpacket      (onchip_memory2_0_s1_to_sgdma_m_read_rsp_width_adapter_src_endofpacket),   //       src.endofpacket
		.out_data             (onchip_memory2_0_s1_to_sgdma_m_read_rsp_width_adapter_src_data),          //          .data
		.out_channel          (onchip_memory2_0_s1_to_sgdma_m_read_rsp_width_adapter_src_channel),       //          .channel
		.out_valid            (onchip_memory2_0_s1_to_sgdma_m_read_rsp_width_adapter_src_valid),         //          .valid
		.out_ready            (onchip_memory2_0_s1_to_sgdma_m_read_rsp_width_adapter_src_ready),         //          .ready
		.out_startofpacket    (onchip_memory2_0_s1_to_sgdma_m_read_rsp_width_adapter_src_startofpacket), //          .startofpacket
		.in_command_size_data (3'b000)                                                                   // (terminated)
	);
	...
	altera_merlin_width_adapter #(
		...
		.PACKING                       (1),
		.ENABLE_ADDRESS_ALIGNMENT      (0)
	) onchip_memory2_0_s1_to_sgdma_m_write_rsp_width_adapter (
		.clk                  (clk_50_clk_clk),                                                           //       clk.clk
		.reset                (onchip_memory2_0_reset1_reset_bridge_in_reset_reset),                      // clk_reset.reset
		...
		.out_endofpacket      (onchip_memory2_0_s1_to_sgdma_m_write_rsp_width_adapter_src_endofpacket),   //       src.endofpacket
		.out_data             (onchip_memory2_0_s1_to_sgdma_m_write_rsp_width_adapter_src_data),          //          .data
		.out_channel          (onchip_memory2_0_s1_to_sgdma_m_write_rsp_width_adapter_src_channel),       //          .channel
		.out_valid            (onchip_memory2_0_s1_to_sgdma_m_write_rsp_width_adapter_src_valid),         //          .valid
		.out_ready            (onchip_memory2_0_s1_to_sgdma_m_write_rsp_width_adapter_src_ready),         //          .ready
		.out_startofpacket    (onchip_memory2_0_s1_to_sgdma_m_write_rsp_width_adapter_src_startofpacket), //          .startofpacket
		.in_command_size_data (3'b000)                                                                    // (terminated)
	);
	...
	altera_avalon_st_handshake_clock_crosser #(
		...
		.in_ready          (sgdma_m_read_to_onchip_memory2_0_s1_cmd_width_adapter_src_ready),         //            in.ready
		.in_valid          (sgdma_m_read_to_onchip_memory2_0_s1_cmd_width_adapter_src_valid),         //              .valid
		.in_startofpacket  (sgdma_m_read_to_onchip_memory2_0_s1_cmd_width_adapter_src_startofpacket), //              .startofpacket
		.in_endofpacket    (sgdma_m_read_to_onchip_memory2_0_s1_cmd_width_adapter_src_endofpacket),   //              .endofpacket
		.in_channel        (sgdma_m_read_to_onchip_memory2_0_s1_cmd_width_adapter_src_channel),       //              .channel
		.in_data           (sgdma_m_read_to_onchip_memory2_0_s1_cmd_width_adapter_src_data),          //              .data
	...
	altera_avalon_st_handshake_clock_crosser #(
		...
		.out_clk           (clk_50_clk_clk),                                                           //       out_clk.clk
		.out_reset         (onchip_memory2_0_reset1_reset_bridge_in_reset_reset),                      // out_clk_reset.reset
		.in_ready          (sgdma_m_write_to_onchip_memory2_0_s1_cmd_width_adapter_src_ready),         //            in.ready
		.in_valid          (sgdma_m_write_to_onchip_memory2_0_s1_cmd_width_adapter_src_valid),         //              .valid
		.in_startofpacket  (sgdma_m_write_to_onchip_memory2_0_s1_cmd_width_adapter_src_startofpacket), //              .startofpacket
		.in_endofpacket    (sgdma_m_write_to_onchip_memory2_0_s1_cmd_width_adapter_src_endofpacket),   //              .endofpacket
		.in_channel        (sgdma_m_write_to_onchip_memory2_0_s1_cmd_width_adapter_src_channel),       //              .channel
		.in_data           (sgdma_m_write_to_onchip_memory2_0_s1_cmd_width_adapter_src_data),          //              .data
	...
	altera_avalon_st_handshake_clock_crosser #(
		...
		.out_clk           (pcie_ip_pcie_core_clk_clk),                                               //       out_clk.clk
		.out_reset         (sgdma_reset_reset_bridge_in_reset_reset),                                 // out_clk_reset.reset
		.in_ready          (onchip_memory2_0_s1_to_sgdma_m_read_rsp_width_adapter_src_ready),         //            in.ready
		.in_valid          (onchip_memory2_0_s1_to_sgdma_m_read_rsp_width_adapter_src_valid),         //              .valid
		.in_startofpacket  (onchip_memory2_0_s1_to_sgdma_m_read_rsp_width_adapter_src_startofpacket), //              .startofpacket
		.in_endofpacket    (onchip_memory2_0_s1_to_sgdma_m_read_rsp_width_adapter_src_endofpacket),   //              .endofpacket
		.in_channel        (onchip_memory2_0_s1_to_sgdma_m_read_rsp_width_adapter_src_channel),       //              .channel
		.in_data           (onchip_memory2_0_s1_to_sgdma_m_read_rsp_width_adapter_src_data),          //              .data
	...
	altera_avalon_st_handshake_clock_crosser #(
		...
		.out_clk           (pcie_ip_pcie_core_clk_clk),                                                //       out_clk.clk
		.out_reset         (sgdma_reset_reset_bridge_in_reset_reset),                                  // out_clk_reset.reset
		.in_ready          (onchip_memory2_0_s1_to_sgdma_m_write_rsp_width_adapter_src_ready),         //            in.ready
		.in_valid          (onchip_memory2_0_s1_to_sgdma_m_write_rsp_width_adapter_src_valid),         //              .valid
		.in_startofpacket  (onchip_memory2_0_s1_to_sgdma_m_write_rsp_width_adapter_src_startofpacket), //              .startofpacket
		.in_endofpacket    (onchip_memory2_0_s1_to_sgdma_m_write_rsp_width_adapter_src_endofpacket),   //              .endofpacket
		.in_channel        (onchip_memory2_0_s1_to_sgdma_m_write_rsp_width_adapter_src_channel),       //              .channel
		.in_data           (onchip_memory2_0_s1_to_sgdma_m_write_rsp_width_adapter_src_data),          //              .data

...
alias com {
  ...
  vlog  "$QSYS_SIMDIR/submodules/ahb_slave_with_pcie_mm_interconnect_2_rsp_mux.sv"       -work rsp_mux                    
  vlog  "$QSYS_SIMDIR/submodules/ahb_slave_with_pcie_mm_interconnect_2_rsp_demux.sv"     -work rsp_demux                  
  vlog  "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                            -work cmd_mux                    
  vlog  "$QSYS_SIMDIR/submodules/ahb_slave_with_pcie_mm_interconnect_2_cmd_mux.sv"       -work cmd_mux                    
  vlog  "$QSYS_SIMDIR/submodules/ahb_slave_with_pcie_mm_interconnect_2_cmd_demux.sv"     -work cmd_demux                  
  vlog  "$QSYS_SIMDIR/submodules/ahb_slave_with_pcie_mm_interconnect_2_router_001.sv"    -work router_001                 
  vlog  "$QSYS_SIMDIR/submodules/ahb_slave_with_pcie_mm_interconnect_2_router.sv"        -work router                     
  ...
  vlog  "$QSYS_SIMDIR/submodules/ahb_slave_with_pcie_mm_interconnect_1_rsp_mux_002.sv"   -work rsp_mux_002                
  vlog  "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                            -work rsp_mux                    
  vlog  "$QSYS_SIMDIR/submodules/ahb_slave_with_pcie_mm_interconnect_1_rsp_mux.sv"       -work rsp_mux                    
  vlog  "$QSYS_SIMDIR/submodules/ahb_slave_with_pcie_mm_interconnect_1_rsp_demux_001.sv" -work rsp_demux_001              
  vlog  "$QSYS_SIMDIR/submodules/ahb_slave_with_pcie_mm_interconnect_1_rsp_demux.sv"     -work rsp_demux                  
  vlog  "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                            -work cmd_mux_002                
  vlog  "$QSYS_SIMDIR/submodules/ahb_slave_with_pcie_mm_interconnect_1_cmd_mux_002.sv"   -work cmd_mux_002                
  vlog  "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                            -work cmd_mux_001                
  vlog  "$QSYS_SIMDIR/submodules/ahb_slave_with_pcie_mm_interconnect_1_cmd_mux_001.sv"   -work cmd_mux_001                
  vlog  "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                            -work cmd_mux                    
  vlog  "$QSYS_SIMDIR/submodules/ahb_slave_with_pcie_mm_interconnect_1_cmd_mux.sv"       -work cmd_mux                    
  vlog  "$QSYS_SIMDIR/submodules/ahb_slave_with_pcie_mm_interconnect_1_cmd_demux_003.sv" -work cmd_demux_003              
  vlog  "$QSYS_SIMDIR/submodules/ahb_slave_with_pcie_mm_interconnect_1_cmd_demux_002.sv" -work cmd_demux_002              
  vlog  "$QSYS_SIMDIR/submodules/ahb_slave_with_pcie_mm_interconnect_1_cmd_demux.sv"     -work cmd_demux                  
  vlog  "$QSYS_SIMDIR/submodules/ahb_slave_with_pcie_mm_interconnect_1_router_005.sv"    -work router_005                 
  vlog  "$QSYS_SIMDIR/submodules/ahb_slave_with_pcie_mm_interconnect_1_router_004.sv"    -work router_004                 
  vlog  "$QSYS_SIMDIR/submodules/ahb_slave_with_pcie_mm_interconnect_1_router_002.sv"    -work router_002                 
  vlog  "$QSYS_SIMDIR/submodules/ahb_slave_with_pcie_mm_interconnect_1_router.sv"        -work router                     
  ...
  vlog  "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                            -work rsp_mux                    
  vlog  "$QSYS_SIMDIR/submodules/ahb_slave_with_pcie_mm_interconnect_0_rsp_mux.sv"       -work rsp_mux                    
  vlog  "$QSYS_SIMDIR/submodules/ahb_slave_with_pcie_mm_interconnect_0_rsp_demux.sv"     -work rsp_demux                  
  vlog  "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                            -work cmd_mux                    
  vlog  "$QSYS_SIMDIR/submodules/ahb_slave_with_pcie_mm_interconnect_0_cmd_mux.sv"       -work cmd_mux                    
  vlog  "$QSYS_SIMDIR/submodules/ahb_slave_with_pcie_mm_interconnect_0_cmd_demux.sv"     -work cmd_demux                  
  ...
  vlog  "$QSYS_SIMDIR/submodules/ahb_slave_with_pcie_mm_interconnect_0_router_001.sv"    -work router_001                 
  vlog  "$QSYS_SIMDIR/submodules/ahb_slave_with_pcie_mm_interconnect_0_router.sv"        -work router                     
  ...
  vlog  "$QSYS_SIMDIR/submodules/ahb_slave_with_pcie_irq_mapper.sv"                      -work irq_mapper                 
  ...
  vlog  "$QSYS_SIMDIR/submodules/top_level.sv"                                           -work top_level_0                
  vlog  "$QSYS_SIMDIR/submodules/avalon_ahb_bridge.sv"                                   -work avalon2ahb_bridge_0        
...
alias elab_debug {
  ...
  eval vsim -dbg -O2 +access +r -t ps $ELAB_OPTIONS -L work -L rsp_mux -L rsp_demux -L cmd_mux -L cmd_demux -L router_001 -L router -L crosser -L rsp_mux_002 -L rsp_demux_001 -L cmd_mux_002 -L cmd_mux_001 -L cmd_demux_003 -L cmd_demux_002 -L router_005 -L router_004 -L router_002 -L sgdma_csr_rsp_width_adapter -L sgdma_csr_burst_adapter -L pcie_ip_bar2_limiter -L sgdma_csr_agent_rsp_fifo -L sgdma_csr_agent -L pcie_ip_bar2_agent -L sgdma_csr_translator -L pcie_ip_bar2_translator -L pipe_interface_internal -L reset_controller_internal -L altgx_internal -L pcie_internal_hip -L rst_controller -L irq_mapper -L mm_interconnect_2 -L mm_interconnect_1 -L mm_interconnect_0 -L onchip_memory2_0 -L top_level_0 -L avalon2ahb_bridge_0 -L altpll_qsys -L sdram -L sgdma -L pcie_ip -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cycloneiv_hssi_ver -L cycloneiv_pcie_hip_ver -L cycloneiv_ver $TOP_LEVEL_NAME
}

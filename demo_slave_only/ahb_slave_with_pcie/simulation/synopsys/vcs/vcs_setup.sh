...
vcs -lca -timescale=1ps/1ps -sverilog +verilog2001ext+.v -ntb_opts dtm $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS \
  ...
  $QSYS_SIMDIR/submodules/ahb_slave_with_pcie_mm_interconnect_2_rsp_mux.sv \
  $QSYS_SIMDIR/submodules/ahb_slave_with_pcie_mm_interconnect_2_rsp_demux.sv \
  $QSYS_SIMDIR/submodules/ahb_slave_with_pcie_mm_interconnect_2_cmd_mux.sv \
  $QSYS_SIMDIR/submodules/ahb_slave_with_pcie_mm_interconnect_2_cmd_demux.sv \
  $QSYS_SIMDIR/submodules/ahb_slave_with_pcie_mm_interconnect_2_router_001.sv \
  $QSYS_SIMDIR/submodules/ahb_slave_with_pcie_mm_interconnect_2_router.sv \
  ...
  $QSYS_SIMDIR/submodules/ahb_slave_with_pcie_mm_interconnect_1_rsp_mux_002.sv \
  $QSYS_SIMDIR/submodules/ahb_slave_with_pcie_mm_interconnect_1_rsp_mux.sv \
  $QSYS_SIMDIR/submodules/ahb_slave_with_pcie_mm_interconnect_1_rsp_demux_001.sv \
  $QSYS_SIMDIR/submodules/ahb_slave_with_pcie_mm_interconnect_1_rsp_demux.sv \
  $QSYS_SIMDIR/submodules/ahb_slave_with_pcie_mm_interconnect_1_cmd_mux_002.sv \
  $QSYS_SIMDIR/submodules/ahb_slave_with_pcie_mm_interconnect_1_cmd_mux_001.sv \
  $QSYS_SIMDIR/submodules/ahb_slave_with_pcie_mm_interconnect_1_cmd_mux.sv \
  $QSYS_SIMDIR/submodules/ahb_slave_with_pcie_mm_interconnect_1_cmd_demux_003.sv \
  $QSYS_SIMDIR/submodules/ahb_slave_with_pcie_mm_interconnect_1_cmd_demux_002.sv \
  $QSYS_SIMDIR/submodules/ahb_slave_with_pcie_mm_interconnect_1_cmd_demux.sv \
  $QSYS_SIMDIR/submodules/ahb_slave_with_pcie_mm_interconnect_1_router_005.sv \
  $QSYS_SIMDIR/submodules/ahb_slave_with_pcie_mm_interconnect_1_router_004.sv \
  $QSYS_SIMDIR/submodules/ahb_slave_with_pcie_mm_interconnect_1_router_002.sv \
  $QSYS_SIMDIR/submodules/ahb_slave_with_pcie_mm_interconnect_1_router.sv \
  ...
  $QSYS_SIMDIR/submodules/ahb_slave_with_pcie_mm_interconnect_0_rsp_mux.sv \
  $QSYS_SIMDIR/submodules/ahb_slave_with_pcie_mm_interconnect_0_rsp_demux.sv \
  $QSYS_SIMDIR/submodules/ahb_slave_with_pcie_mm_interconnect_0_cmd_mux.sv \
  $QSYS_SIMDIR/submodules/ahb_slave_with_pcie_mm_interconnect_0_cmd_demux.sv \
  ...
  $QSYS_SIMDIR/submodules/ahb_slave_with_pcie_mm_interconnect_0_router_001.sv \
  $QSYS_SIMDIR/submodules/ahb_slave_with_pcie_mm_interconnect_0_router.sv \
  ...
  $QSYS_SIMDIR/submodules/ahb_slave_with_pcie_pcie_ip_altgx_internal.vo \
  ...
  $QSYS_SIMDIR/submodules/ahb_slave_with_pcie_irq_mapper.sv \
  $QSYS_SIMDIR/submodules/ahb_slave_with_pcie_mm_interconnect_2.v \
  $QSYS_SIMDIR/submodules/ahb_slave_with_pcie_mm_interconnect_1.v \
  $QSYS_SIMDIR/submodules/ahb_slave_with_pcie_mm_interconnect_0.v \
  $QSYS_SIMDIR/submodules/ahb_slave_with_pcie_onchip_memory2_0.v \
  $QSYS_SIMDIR/submodules/top_level.sv \
  $QSYS_SIMDIR/submodules/avalon_ahb_bridge.sv \
  $QSYS_SIMDIR/submodules/ahb_slave_with_pcie_altpll_qsys.vo \
  $QSYS_SIMDIR/submodules/ahb_slave_with_pcie_sdram.v \
  $QSYS_SIMDIR/submodules/ahb_slave_with_pcie_sgdma.v \
  $QSYS_SIMDIR/submodules/ahb_slave_with_pcie_pcie_ip.v \
  $QSYS_SIMDIR/ahb_slave_with_pcie.v \
  -top $TOP_LEVEL_NAME
# ----------------------------------------
# simulate

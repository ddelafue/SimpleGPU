...
if [ $SKIP_COM -eq 0 ]; then
  ...
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/ahb_slave_with_pcie_mm_interconnect_2_rsp_mux.sv"         -work rsp_mux                    
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/ahb_slave_with_pcie_mm_interconnect_2_rsp_demux.sv"       -work rsp_demux                  
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                              -work cmd_mux                    
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/ahb_slave_with_pcie_mm_interconnect_2_cmd_mux.sv"         -work cmd_mux                    
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/ahb_slave_with_pcie_mm_interconnect_2_cmd_demux.sv"       -work cmd_demux                  
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/ahb_slave_with_pcie_mm_interconnect_2_router_001.sv"      -work router_001                 
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/ahb_slave_with_pcie_mm_interconnect_2_router.sv"          -work router                     
  ...
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/ahb_slave_with_pcie_mm_interconnect_1_rsp_mux_002.sv"     -work rsp_mux_002                
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                              -work rsp_mux                    
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/ahb_slave_with_pcie_mm_interconnect_1_rsp_mux.sv"         -work rsp_mux                    
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/ahb_slave_with_pcie_mm_interconnect_1_rsp_demux_001.sv"   -work rsp_demux_001              
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/ahb_slave_with_pcie_mm_interconnect_1_rsp_demux.sv"       -work rsp_demux                  
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                              -work cmd_mux_002                
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/ahb_slave_with_pcie_mm_interconnect_1_cmd_mux_002.sv"     -work cmd_mux_002                
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                              -work cmd_mux_001                
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/ahb_slave_with_pcie_mm_interconnect_1_cmd_mux_001.sv"     -work cmd_mux_001                
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                              -work cmd_mux                    
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/ahb_slave_with_pcie_mm_interconnect_1_cmd_mux.sv"         -work cmd_mux                    
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/ahb_slave_with_pcie_mm_interconnect_1_cmd_demux_003.sv"   -work cmd_demux_003              
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/ahb_slave_with_pcie_mm_interconnect_1_cmd_demux_002.sv"   -work cmd_demux_002              
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/ahb_slave_with_pcie_mm_interconnect_1_cmd_demux.sv"       -work cmd_demux                  
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/ahb_slave_with_pcie_mm_interconnect_1_router_005.sv"      -work router_005                 
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/ahb_slave_with_pcie_mm_interconnect_1_router_004.sv"      -work router_004                 
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/ahb_slave_with_pcie_mm_interconnect_1_router_002.sv"      -work router_002                 
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/ahb_slave_with_pcie_mm_interconnect_1_router.sv"          -work router                     
  ...
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                              -work rsp_mux                    
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/ahb_slave_with_pcie_mm_interconnect_0_rsp_mux.sv"         -work rsp_mux                    
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/ahb_slave_with_pcie_mm_interconnect_0_rsp_demux.sv"       -work rsp_demux                  
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                              -work cmd_mux                    
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/ahb_slave_with_pcie_mm_interconnect_0_cmd_mux.sv"         -work cmd_mux                    
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/ahb_slave_with_pcie_mm_interconnect_0_cmd_demux.sv"       -work cmd_demux                  
  ...
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/ahb_slave_with_pcie_mm_interconnect_0_router_001.sv"      -work router_001                 
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/ahb_slave_with_pcie_mm_interconnect_0_router.sv"          -work router                     
  ...
  vlogan +v2k           "$QSYS_SIMDIR/submodules/ahb_slave_with_pcie_pcie_ip_altgx_internal.vo"            -work altgx_internal             
  ...
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/ahb_slave_with_pcie_irq_mapper.sv"                        -work irq_mapper                 
  vlogan +v2k           "$QSYS_SIMDIR/submodules/ahb_slave_with_pcie_mm_interconnect_2.v"                  -work mm_interconnect_2          
  vlogan +v2k           "$QSYS_SIMDIR/submodules/ahb_slave_with_pcie_mm_interconnect_1.v"                  -work mm_interconnect_1          
  vlogan +v2k           "$QSYS_SIMDIR/submodules/ahb_slave_with_pcie_mm_interconnect_0.v"                  -work mm_interconnect_0          
  vlogan +v2k           "$QSYS_SIMDIR/submodules/ahb_slave_with_pcie_onchip_memory2_0.v"                   -work onchip_memory2_0           
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/top_level.sv"                                             -work top_level_0                
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/avalon_ahb_bridge.sv"                                     -work avalon2ahb_bridge_0        
  vlogan +v2k           "$QSYS_SIMDIR/submodules/ahb_slave_with_pcie_altpll_qsys.vo"                       -work altpll_qsys                
  vlogan +v2k           "$QSYS_SIMDIR/submodules/ahb_slave_with_pcie_sdram.v"                              -work sdram                      
  vlogan +v2k           "$QSYS_SIMDIR/submodules/ahb_slave_with_pcie_sgdma.v"                              -work sgdma                      
  vlogan +v2k           "$QSYS_SIMDIR/submodules/ahb_slave_with_pcie_pcie_ip.v"                            -work pcie_ip                    
  vlogan +v2k           "$QSYS_SIMDIR/ahb_slave_with_pcie.v"                                                                                
fi

...
# ACDS 14.0 200 linux 2016.04.18.21:09:25
...
TOP_LEVEL_NAME="ahb_slave_with_pcie"
QSYS_SIMDIR="./../"
...
if [ $SKIP_FILE_COPY -eq 0 ]; then
  cp -f $QSYS_SIMDIR/submodules/ahb_slave_with_pcie_onchip_memory2_0.hex ./
fi
...
if [ $SKIP_COM -eq 0 ]; then
  ...
  ncvlog -sv "$QSYS_SIMDIR/submodules/ahb_slave_with_pcie_mm_interconnect_2_rsp_mux.sv"        -work rsp_mux                     -cdslib ./cds_libs/rsp_mux.cds.lib                    
  ncvlog -sv "$QSYS_SIMDIR/submodules/ahb_slave_with_pcie_mm_interconnect_2_rsp_demux.sv"      -work rsp_demux                   -cdslib ./cds_libs/rsp_demux.cds.lib                  
  ncvlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                             -work cmd_mux                     -cdslib ./cds_libs/cmd_mux.cds.lib                    
  ncvlog -sv "$QSYS_SIMDIR/submodules/ahb_slave_with_pcie_mm_interconnect_2_cmd_mux.sv"        -work cmd_mux                     -cdslib ./cds_libs/cmd_mux.cds.lib                    
  ncvlog -sv "$QSYS_SIMDIR/submodules/ahb_slave_with_pcie_mm_interconnect_2_cmd_demux.sv"      -work cmd_demux                   -cdslib ./cds_libs/cmd_demux.cds.lib                  
  ncvlog -sv "$QSYS_SIMDIR/submodules/ahb_slave_with_pcie_mm_interconnect_2_router_001.sv"     -work router_001                  -cdslib ./cds_libs/router_001.cds.lib                 
  ncvlog -sv "$QSYS_SIMDIR/submodules/ahb_slave_with_pcie_mm_interconnect_2_router.sv"         -work router                      -cdslib ./cds_libs/router.cds.lib                     
  ...
  ncvlog -sv "$QSYS_SIMDIR/submodules/ahb_slave_with_pcie_mm_interconnect_1_rsp_mux_002.sv"    -work rsp_mux_002                 -cdslib ./cds_libs/rsp_mux_002.cds.lib                
  ncvlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                             -work rsp_mux                     -cdslib ./cds_libs/rsp_mux.cds.lib                    
  ncvlog -sv "$QSYS_SIMDIR/submodules/ahb_slave_with_pcie_mm_interconnect_1_rsp_mux.sv"        -work rsp_mux                     -cdslib ./cds_libs/rsp_mux.cds.lib                    
  ncvlog -sv "$QSYS_SIMDIR/submodules/ahb_slave_with_pcie_mm_interconnect_1_rsp_demux_001.sv"  -work rsp_demux_001               -cdslib ./cds_libs/rsp_demux_001.cds.lib              
  ncvlog -sv "$QSYS_SIMDIR/submodules/ahb_slave_with_pcie_mm_interconnect_1_rsp_demux.sv"      -work rsp_demux                   -cdslib ./cds_libs/rsp_demux.cds.lib                  
  ncvlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                             -work cmd_mux_002                 -cdslib ./cds_libs/cmd_mux_002.cds.lib                
  ncvlog -sv "$QSYS_SIMDIR/submodules/ahb_slave_with_pcie_mm_interconnect_1_cmd_mux_002.sv"    -work cmd_mux_002                 -cdslib ./cds_libs/cmd_mux_002.cds.lib                
  ncvlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                             -work cmd_mux_001                 -cdslib ./cds_libs/cmd_mux_001.cds.lib                
  ncvlog -sv "$QSYS_SIMDIR/submodules/ahb_slave_with_pcie_mm_interconnect_1_cmd_mux_001.sv"    -work cmd_mux_001                 -cdslib ./cds_libs/cmd_mux_001.cds.lib                
  ncvlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                             -work cmd_mux                     -cdslib ./cds_libs/cmd_mux.cds.lib                    
  ncvlog -sv "$QSYS_SIMDIR/submodules/ahb_slave_with_pcie_mm_interconnect_1_cmd_mux.sv"        -work cmd_mux                     -cdslib ./cds_libs/cmd_mux.cds.lib                    
  ncvlog -sv "$QSYS_SIMDIR/submodules/ahb_slave_with_pcie_mm_interconnect_1_cmd_demux_003.sv"  -work cmd_demux_003               -cdslib ./cds_libs/cmd_demux_003.cds.lib              
  ncvlog -sv "$QSYS_SIMDIR/submodules/ahb_slave_with_pcie_mm_interconnect_1_cmd_demux_002.sv"  -work cmd_demux_002               -cdslib ./cds_libs/cmd_demux_002.cds.lib              
  ncvlog -sv "$QSYS_SIMDIR/submodules/ahb_slave_with_pcie_mm_interconnect_1_cmd_demux.sv"      -work cmd_demux                   -cdslib ./cds_libs/cmd_demux.cds.lib                  
  ncvlog -sv "$QSYS_SIMDIR/submodules/ahb_slave_with_pcie_mm_interconnect_1_router_005.sv"     -work router_005                  -cdslib ./cds_libs/router_005.cds.lib                 
  ncvlog -sv "$QSYS_SIMDIR/submodules/ahb_slave_with_pcie_mm_interconnect_1_router_004.sv"     -work router_004                  -cdslib ./cds_libs/router_004.cds.lib                 
  ncvlog -sv "$QSYS_SIMDIR/submodules/ahb_slave_with_pcie_mm_interconnect_1_router_002.sv"     -work router_002                  -cdslib ./cds_libs/router_002.cds.lib                 
  ncvlog -sv "$QSYS_SIMDIR/submodules/ahb_slave_with_pcie_mm_interconnect_1_router.sv"         -work router                      -cdslib ./cds_libs/router.cds.lib                     
  ...
  ncvlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                             -work rsp_mux                     -cdslib ./cds_libs/rsp_mux.cds.lib                    
  ncvlog -sv "$QSYS_SIMDIR/submodules/ahb_slave_with_pcie_mm_interconnect_0_rsp_mux.sv"        -work rsp_mux                     -cdslib ./cds_libs/rsp_mux.cds.lib                    
  ncvlog -sv "$QSYS_SIMDIR/submodules/ahb_slave_with_pcie_mm_interconnect_0_rsp_demux.sv"      -work rsp_demux                   -cdslib ./cds_libs/rsp_demux.cds.lib                  
  ncvlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                             -work cmd_mux                     -cdslib ./cds_libs/cmd_mux.cds.lib                    
  ncvlog -sv "$QSYS_SIMDIR/submodules/ahb_slave_with_pcie_mm_interconnect_0_cmd_mux.sv"        -work cmd_mux                     -cdslib ./cds_libs/cmd_mux.cds.lib                    
  ncvlog -sv "$QSYS_SIMDIR/submodules/ahb_slave_with_pcie_mm_interconnect_0_cmd_demux.sv"      -work cmd_demux                   -cdslib ./cds_libs/cmd_demux.cds.lib                  
  ...
  ncvlog -sv "$QSYS_SIMDIR/submodules/ahb_slave_with_pcie_mm_interconnect_0_router_001.sv"     -work router_001                  -cdslib ./cds_libs/router_001.cds.lib                 
  ncvlog -sv "$QSYS_SIMDIR/submodules/ahb_slave_with_pcie_mm_interconnect_0_router.sv"         -work router                      -cdslib ./cds_libs/router.cds.lib                     
  ...
  ncvlog     "$QSYS_SIMDIR/submodules/ahb_slave_with_pcie_pcie_ip_altgx_internal.vo"           -work altgx_internal              -cdslib ./cds_libs/altgx_internal.cds.lib             
  ...
  ncvlog -sv "$QSYS_SIMDIR/submodules/ahb_slave_with_pcie_irq_mapper.sv"                       -work irq_mapper                  -cdslib ./cds_libs/irq_mapper.cds.lib                 
  ncvlog     "$QSYS_SIMDIR/submodules/ahb_slave_with_pcie_mm_interconnect_2.v"                 -work mm_interconnect_2           -cdslib ./cds_libs/mm_interconnect_2.cds.lib          
  ncvlog     "$QSYS_SIMDIR/submodules/ahb_slave_with_pcie_mm_interconnect_1.v"                 -work mm_interconnect_1           -cdslib ./cds_libs/mm_interconnect_1.cds.lib          
  ncvlog     "$QSYS_SIMDIR/submodules/ahb_slave_with_pcie_mm_interconnect_0.v"                 -work mm_interconnect_0           -cdslib ./cds_libs/mm_interconnect_0.cds.lib          
  ncvlog     "$QSYS_SIMDIR/submodules/ahb_slave_with_pcie_onchip_memory2_0.v"                  -work onchip_memory2_0            -cdslib ./cds_libs/onchip_memory2_0.cds.lib           
  ncvlog -sv "$QSYS_SIMDIR/submodules/top_level.sv"                                            -work top_level_0                 -cdslib ./cds_libs/top_level_0.cds.lib                
  ncvlog -sv "$QSYS_SIMDIR/submodules/avalon_ahb_bridge.sv"                                    -work avalon2ahb_bridge_0         -cdslib ./cds_libs/avalon2ahb_bridge_0.cds.lib        
  ncvlog     "$QSYS_SIMDIR/submodules/ahb_slave_with_pcie_altpll_qsys.vo"                      -work altpll_qsys                 -cdslib ./cds_libs/altpll_qsys.cds.lib                
  ncvlog     "$QSYS_SIMDIR/submodules/ahb_slave_with_pcie_sdram.v"                             -work sdram                       -cdslib ./cds_libs/sdram.cds.lib                      
  ncvlog     "$QSYS_SIMDIR/submodules/ahb_slave_with_pcie_sgdma.v"                             -work sgdma                       -cdslib ./cds_libs/sgdma.cds.lib                      
  ncvlog     "$QSYS_SIMDIR/submodules/ahb_slave_with_pcie_pcie_ip.v"                           -work pcie_ip                     -cdslib ./cds_libs/pcie_ip.cds.lib                    
  ncvlog     "$QSYS_SIMDIR/ahb_slave_with_pcie.v"                                                                                                                                      
fi
